...
class MovieLib:
    ...
    def __str__(self):
        ...
        """
        # method goes here
        # if the movie library is empty an empty string is returned
        if print(self.bst) is None:
            return ""
        # calls __str__ from BSTNode class
        return self.bst
    ...
    def search(self, title):
        ...
        # searching if a library hasnt been created
        if self.bst is None:
            return None
        movietosearch = Movie(title)
        return self.bst.search(movietosearch)
    ...
    def add(self, title, date, runtime):
        ...
        #must create the library if there is none
        if self.bst is None:
    ...
    def remove(self, title):
        ...
        if self.bst is None:
            return None
        movietoremove = Movie(title)
        return self.bst.remove(movietoremove)
...
newrepeatedlibrary = build_library('small_repeated_movies.txt')
newbiglibrary = build_library('movies.txt')
